...
export interface GameController { start(): void; pause(): void; restart(): void; destroy(): void; control?(action: string, pressed: boolean): void; controlPosition?(position: number): void; }
